    ...
    <div className="faq">
      <div className="faq-inner">
        ...
        <QA q="Does anything I type get saved or sent anywhere?">
          ...
          can confirm this yourself in your browser&rsquo;s developer tools (Network tab): no request
          carries your content. You download the files and handle them yourself.
        </QA>
