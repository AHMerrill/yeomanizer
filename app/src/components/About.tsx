...
const AVAILABLE: [string, string][] = [
  ...
  ['Endorsements', 'Add a Via and the endorsement appends as its own page (9-2) — its own identification symbols, its own signature block and CAC-signable field, and optional letterhead for the endorsing activity (fig 9-2). A long endorsement paginates and repeats the Subj line, just like the basic letter.'],
  ['Executive memo (Action / Info / Memorandum For)', 'The HqDON/OSD staff memo (Ch 12, figs 12-9/12-11/12-14): a centered “ACTION MEMO” or “INFO MEMO” with FOR:/FROM:/SUBJECT: (Title Case), bulleted paragraphs, and — for an action memo — a RECOMMENDATION with an Approve/Disapprove decision block, plus COORDINATION, Attachments, and “Prepared by.” Or a plain “Memorandum For” — “MEMORANDUM FOR <recipient>” addressing, indented paragraphs, a centered signature, and a cc: line.'],
  ['Coordination page', 'The plain-bond concurrence table that rides with an action memo (Ch 12, fig 12-13): a centered “COORDINATION PAGE” over one row per reviewing office — Office/Dept, Point of Contact/Title, Phone, Date, and Remarks (Concur / Nonconcur / Reviewed). Add or remove offices; the same aligned table renders in the preview, PDF, and Word.'],
  ['NATO travel order', 'The bilingual two-page form, with U.S. → NATO rank codes filled in — and CUI marking (banner top &amp; bottom, designation block) when you enable it.'],
  ['Live preview', 'Overleaf-style: the formatted page updates with every keystroke.'],
  ['Start from an example', 'One click fills the editor with a correctly-structured letter — appreciation, request, memo for the record, business letter, congressional response, interim reply, or flag stationery (Ch 12) — that you then edit. Undoable.'],
  ['CAC-signable PDF', 'One pixel-accurate PDF of the whole package — letter, endorsements, enclosures, CUI — with selectable, searchable text and a built-in CAC signature field over every signing space — the letter, each endorsement, both parties of an MOA, and every command on a joint letter. Open it to print, save, or sign (no Prepare-a-Form step).'],
  ['Word (.docx) export', 'An editable Word version of the full document — endorsements, enclosures, and CUI included — on US Letter, with the identification block, signatures, and page rhythm laid out to match the PDF and the manual, not Word’s defaults.'],
  ...
  ['Letterhead control', 'Printed, plain paper, or pre-printed stock; the authentic DoD/DoW seal; an editable top line and a title-only mode for flag or personal stationery.'],
  ...
  ['Proofread tab', 'A pre-send review built on SECNAV M-5216.5 Ch 2 ¶19 — live checks on your draft (subject case, From/To, signature, lone subparagraphs…), the format items the engine guarantees for you, and the substance items you confirm. Type-aware — it won’t nag a coordination page for a subject line or an executive memo for an all-caps one. Advisory only; it never blocks an export.'],
